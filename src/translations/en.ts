...
export const en = {
    ...
    'page.body.plugins.wallet.withdraw.info.tip2': '2. When withdrawing to the CX user\'s address, the handling fee will be returned to the Current Account by default. Learn more',
