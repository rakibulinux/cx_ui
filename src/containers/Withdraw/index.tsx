...
export interface WithdrawProps {
    ...
    withdrawButtonEnable2faLabel?: string;
    withdrawRequireEnable2faLabel?: string;
...
class WithdrawContainer extends React.Component<WithdrawProps, WithdrawState> {
    public state = {
        amount: '',
    ...
    public componentDidMount() {
        const { isEnable2Fa, isMobileDevice, withdrawRequireEnable2faLabel } = this.props;
        if (isMobileDevice && !isEnable2Fa) {
            notification.warning({
                message: withdrawRequireEnable2faLabel || 'To withdraw you have to enable 2FA',
            });
        }
    }
    ...
    private renderOtpCodeInput = () => {
        ...
        const { withdraw2faLabel, withdrawButtonEnable2faLabel, isEnable2Fa, isMobileDevice } = this.props;
...
export const Withdraw = React.memo(WithdrawContainer, isEqual);
